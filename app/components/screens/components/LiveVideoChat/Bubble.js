    ...
    onLongPress() {
        if (this.props.onLongPress) {
            ...
            if (this.props.currentMessage.text) {
                const options = ['Copy Text', 'Report Message', `Report @${this.props.currentMessage.user.name}`, 'Cancel']
                    ...
                    buttonIndex => {
                        switch (buttonIndex) {
                            case 0:
                                ...
                                break
                            case 1:
                                toast('The message has been reported')
                                break;
                            case 2:
                                toast('The user has been reported')
                                break;
                        }
                    },
                )
