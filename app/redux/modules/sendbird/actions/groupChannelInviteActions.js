...
import { sbGetUserList, sbGetGroupChannel, sbCreateGroupChannelWithParams, sbInviteGroupChannel } from '../sendbirdActions';
...
export const createGroupChannel = (params) => {
  return dispatch => {
    return sbCreateGroupChannelWithParams(params)
      .then(channel => {
        dispatch({
