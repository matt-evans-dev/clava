...
export const JOINED_GROUP_CHANNEL_FAIL = 'join_group_channel_fail';
export const JOINED_GROUP_CHANNEL = 'joined_group_channel';
...
export const REMOVED_MESSAGE_REACTION = 'removed_message_reaction';
export const ADDED_MESSAGE_REACTION = 'added_message_reaction';
